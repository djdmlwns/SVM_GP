...
C1 = 0.0 # weight on the uncertainty
...
# %%
# Save results
np.save("final_result_opt_200_dett8d_lhsinitial_C1_000_thr10.npy", np.array(score_multi_list))
np.save("final_result_lhs_200_dett8d_lhsinitial_C1_000_thr10.npy", np.array(score_random_list))
np.save("final_result_ran_200_dett8d_lhsinitial_C1_000_thr10.npy", np.array(score_trueran_list))
#%%
...
plt.title('Dett 8D with C1=0.0 and threshold 10')
plt.xlabel('Samples')
