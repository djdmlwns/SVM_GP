...
#        F1_score = 2 * precision * recall / (precision + recall)
        # Use Matthews correlation coefficient
        MCC = (TP * TN - FP * FN) / sqrt((TP + FP) * (TP + FN) * (TN + FP) * (TN + FN))
#        score_lst.append(F1_score)
        score_lst.append(MCC)
...
# Save results
np.save("MCC_score_final_result_opt_1000_Dette8d_C1_100_GP_opt_over21.npy", np.array(score_multi_list))
np.save("MCC_score_final_result_lhs_1000_Dette8d_C1_100_GP_opt_over21.npy", np.array(score_random_list))
np.save("MCC_score_final_result_ran_1000_Dette8d_C1_100_GP_opt_over21.npy", np.array(score_trueran_list))
np.save("MCC_score_extended_num_iter_list_1000_Dette8d_C1_100_GP_opt_over21.npy", np.array(extended_num_itr_list))
