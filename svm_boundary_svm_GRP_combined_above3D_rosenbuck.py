...
mainloop(svm_classifier = svm_classifier, Gaussian_regressor=Gaussian_regressor,
...
X_random = lhs(dim, samples= initial_sample_number + num_iter, random_state=random_state)
y_random = []
for _X in X_random:
