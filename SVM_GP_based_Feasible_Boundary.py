...
max_itr = 150                # number of additional samples
...
accuracy_method = 'MCC'        # method to calculate svm accuracy {'F1', 'MCC', 'Simple'}
...
#%%
# Save results
# np.save("F1_score_final_result_opt_1000_Dette8d_C1_100_GP_opt_over21.npy", np.array(opt_score_list))
# np.save("F1_score_final_result_lhs_1000_Dette8d_C1_100_GP_opt_over21.npy", np.array(lhs_score_list))
# np.save("F1_score_final_result_ran_1000_Dette8d_C1_100_GP_opt_over21.npy", np.array(rand_score_list))
