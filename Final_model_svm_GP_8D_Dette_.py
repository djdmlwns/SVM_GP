...
max_itr = 30                # number of additional samples
...
# Save results
#np.save("F1_score_final_result_opt_300_Dette8d_C1_10_GP_opt.npy", np.array(score_multi_list))
#np.save("F1_score_final_result_lhs_300_Dette8d_C1_10_GP_opt.npy", np.array(score_random_list))
#np.save("F1_score_final_result_ran_300_Dette8d_C1_10_GP_opt.npy", np.array(score_trueran_list))
#np.save("extended_num_itr_list_300_Dette8d_C1_10_GP_opt.npy", np.array(extended_num_itr_list))
