...
#%%
# Save results
np.save("opt_score_list.npy", np.array(opt_score_list))
np.save("lhs_score_list.npy", np.array(lhs_score_list))
np.save("rand_score_list.npy", np.array(rand_score_list))
