...
def Progress_plot(num_iter_list, X_initial, opt_score_list, lhs_score_list, rand_score_list, title, method):
    '''
    Plot progress plot
...
def Required_sample(threshold_start, threshold_stop, opt_score_list, lhs_score_list, rand_score_list, extended_num_itr_list):
    '''
