...
C1 = 1e-1 # weight on the uncertainty
...
# %%
# Save results
np.save("final_result_opt_500_hett6d_lhsinitial_c1_01_threshold02.npy", np.array(score_multi_list))
np.save("final_result_lhs_500_hett6d_lhsinitial_c1_01_threshold02.npy", np.array(score_random_list))
np.save("final_result_ran_500_hett6d_lhsinitial_c1_01_threshold02.npy", np.array(score_trueran_list))
#%%
...
plt.title('Hertmann 6D with C1=0.1 and 40% volume and iteration 500')
plt.xlabel('Samples')
