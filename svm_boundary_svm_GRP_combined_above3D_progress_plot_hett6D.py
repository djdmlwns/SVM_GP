...
np.save("final_result_opt_200_hett6d.npy", np.array(score_list))
...
np.save("final_result_lhs_200_hett6d.npy", np.array(score_random_list))
# %%
score_trueran_list = []
# True random
for _num_iter in np.arange(10,max_itr+10,10):
...
np.save("final_result_ran_200_hett6d.npy", np.array(score_trueran_list))
#%%
