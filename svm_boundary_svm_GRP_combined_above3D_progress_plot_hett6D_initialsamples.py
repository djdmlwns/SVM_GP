...
# %%
# Save results
np.save("final_result_opt_200_hett6d_lhsinitial.npy", np.array(score_multi_list))
np.save("final_result_lhs_200_hett6d_lhsinitial.npy", np.array(score_random_list))
np.save("final_result_ran_200_hett6d_lhsinitial.npy", np.array(score_trueran_list))
#%%
...
plt.title('Hertmann 6D with C1=10')
plt.xlabel('Samples')
