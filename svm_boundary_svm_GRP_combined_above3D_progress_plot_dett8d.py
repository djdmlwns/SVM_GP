...
np.save("final_result_opt_200_dett8d.npy", np.array(score_list))
...
np.save("final_result_lhs_200_dett8d.npy", np.array(score_random_list))

#%%
plt.plot(num_iter_list, score_list, num_iter_list, np.mean(score_random_list, axis=1))
plt.legend(['Optimization','LHS'])
plt.title('Dette 8D')
plt.xlabel('Samples')
