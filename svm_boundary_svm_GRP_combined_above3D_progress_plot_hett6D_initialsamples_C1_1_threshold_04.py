...
# %%
# Save results
np.save("final_result_opt_200_hett6d_lhsinitial_c1_1_threshold04.npy", np.array(score_multi_list))
np.save("final_result_lhs_200_hett6d_lhsinitial_c1_1_threshold04.npy", np.array(score_random_list))
np.save("final_result_ran_200_hett6d_lhsinitial_c1_1_threshold04.npy", np.array(score_trueran_list))
#%%
...
plt.title('Hertmann 6D with C1=1 with 20% volume')
plt.xlabel('Samples')
