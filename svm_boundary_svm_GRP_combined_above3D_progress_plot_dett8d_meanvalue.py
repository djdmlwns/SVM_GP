...
np.save("final_result_opt_300_dett8d.npy", np.array(score_list))
...
np.save("final_result_lhs_300_dett8d.npy", np.array(score_random_list))
...
np.save("final_result_ran_300_dett8d.npy", np.array(score_trueran_list))
#%%
