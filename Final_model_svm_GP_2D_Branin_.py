...
# Save results
np.save("F1_score_final_result_opt_200_Branin2d_lhsinitial_C1_10.npy", np.array(score_multi_list))
np.save("F1_score_final_result_lhs_200_Branin2d_lhsinitial_C1_10.npy", np.array(score_random_list))
np.save("F1_score_final_result_ran_200_Branin2d_lhsinitial_C1_10.npy", np.array(score_trueran_list))
