...
C1 = 1e3                 # weight on the uncertainty
report_frq = 5
...
title = 'Branin 2D with C1=' + str(C1) + ' and fixed hyperparameter for GP and F1 score'
...
# Save results
#np.save("F1_score_final_result_opt_100_Branin2d_lhsinitial_C1_1000.npy", np.array(score_multi_list))
#np.save("F1_score_final_result_lhs_100_Branin2d_lhsinitial_C1_1000.npy", np.array(score_random_list))
#np.save("F1_score_final_result_ran_100_Branin2d_lhsinitial_C1_1000.npy", np.array(score_trueran_list))
