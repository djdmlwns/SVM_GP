...
extended_num_list = plot_progress_plot(num_iter_list= num_iter_list, X_initial = X_initial, score_multi_list=score_multi_list,
                    score_random_list = score_random_list, score_trueran_list= score_trueran_list,
                    title = title)

# Save results
np.save("F1_score_final_result_opt_500_Dette8d_C1_10_GP_opt.npy", np.array(score_multi_list))
np.save("F1_score_final_result_lhs_500_Dette8d_C1_10_GP_opt.npy", np.array(score_random_list))
np.save("F1_score_final_result_ran_500_Dette8d_C1_10_GP_opt.npy", np.array(score_trueran_list))
np.save("F1_score_extended_num_list_itr500_Dette8d_C1_10_GP_opt.npy", np.array(extended_num_list))
