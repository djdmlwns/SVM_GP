...
# %%
# Save results
np.save("final_result_opt_200_hett4d_lhsinitial_C1_01.npy", np.array(score_multi_list))
np.save("final_result_lhs_200_hett4d_lhsinitial_C1_01.npy", np.array(score_random_list))
np.save("final_result_ran_200_hett4d_lhsinitial_C1_01.npy", np.array(score_trueran_list))

#%%
extended_num_iter_list = np.array(num_iter_list) + X_initial.shape[0]
np.save("extended_num_iter_list.npy", extended_num_iter_list)
...
plt.title('Hertmann 4D with C1=0.1')
plt.xlabel('Samples')
